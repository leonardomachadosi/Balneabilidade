...
public class BalneabilidadeMapsFragment extends Fragment implements OnMapReadyCallback {
                            ...
                            if (data != null) {
                                for (Map<String, Object> cap : data) {
                                    ...
                                    if (dataAuxiliar.getResource().getLat() != null) {
                                        if (dataAuxiliar.getResource().getLon().equals(marker.getPosition().longitude)
                                                && dataAuxiliar.getResource().getLat().equals(marker.getPosition().latitude)) {
    ...
    private void plot(CapabilityDataAuxiliar capabilityDataAuxiliar) {
        ...
        LatLng now = new LatLng(capabilityDataAuxiliar.getResource().getLat(), capabilityDataAuxiliar.getResource().getLon());
